...
export const addCart = (productSelect, cartContainer) => {
  ...
  if (selectedProduct && selectedProduct.quantity > 0) {
    ...
    if (cartItem) {
      ...
      addNewCartItem(cartContainer, selectedProduct);
    }
...
// 기존 장바구니 아이템 업데이트
const updateExistingCartItem = (cartItem, selectedProduct) => {
...
// 새로운 장바구니 아이템 추가
const addNewCartItem = (cartContainer, selectedProduct) => {
