...
const DISCOUTNT_RULES_OF_TUESDAY = { discountRate: 0.1, dayNumber: 2 };
const MESSAGE = {
  SUPRISE_SALE: (name) => '번개세일! ' + name + '이(가) 20% 할인 중입니다!',
  ADDITIONAL_SALE: (name) => name + '은(는) 어떠세요? 지금 구매하시면 5% 추가 할인!',
