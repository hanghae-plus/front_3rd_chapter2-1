...
export function initializeTimedEvents(products: IProductList[], updateProductStock: (id: string, change: number) => void) {
  startLightningSale(products, updateProductStock);
  startProductSuggestions(products, updateProductStock);
}

function startLightningSale(products: IProductList[], updateProductStock: (id: string, change: number) => void) {
  setTimeout(() => {
    setInterval(() => {
...
function startProductSuggestions(products: IProductList[], updateProductStock: (id: string, change: number) => void) {
