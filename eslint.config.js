...
export default [
  ...
  pluginReact.configs.flat.recommended,
  {
    ...
    rules: {
      ...
      "arrow-body-style": ["error", "as-needed"], // 화살표 함수 단일표현식 중괄호 삭제
      "no-shadow": "error", // 변수 섀도잉 방지(상위스코프와 동일한 하위스코프의 변수 네이밍)
      "no-magic-numbers": ["warn", { ignore: [0, 1] }], // 매직넘버 사용금지
      "no-multi-spaces": ["error"], // 여러 개의 연속된 공백 금지
      "space-before-function-paren": ["error", "never"], // 함수 앞 공백 정의
    },
  },
];
